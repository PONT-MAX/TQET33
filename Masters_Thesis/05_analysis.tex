...
\begin{itemize}
\item Make a more agile feeding program of the measurements matrices. The videos took some time to generate and with a third party video player which was not designed for this kinds of application was not reliable. If I had more time I would have created a simple graphics application which could feed the measurement matrices.
\end{itemize}
